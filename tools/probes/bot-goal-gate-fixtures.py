...
# -*- coding: utf-8 -*-
# ============================================================================
#  判据资产 - 片BU-R4：`bot-goal-gate.py` 的**两次自检夹具**（anti-gaming.md §五）
#
#  为什么需要它：片BU-R4 改了 bot-goal-gate.py 的判据（A1/A2 由"全体必须推进"改为
#  有条件 + 新增 A9）。规则要求：**改判据之后必须做两次自检 —— 已知正确的样本必须 PASS、
