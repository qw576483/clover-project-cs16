...
**必读**：
- `docs/步骤文档.md` §3
- `clover-tools/ai-skill/reference/asset-sources.md`（**素材四级链 + 自动获取**）
- `clover-tools/ai-skill/reference/engine-mental-model.md` §4/§6（`Game.Res`/`Game.Anim`/`Game.Pool`、**量测优先**）
- `clover-tools/ai-skill/patterns/client/3d-mmo-basics.md` §7/§8（动画四件事、头顶血条、占位物必须移除）
- `clover-tools/ai-skill/patterns/client/resource.md`（资源清单模板）
