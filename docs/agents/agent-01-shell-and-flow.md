...
**必读**（按序）：
- `docs/步骤文档.md` §3（关键契约速查）
- `clover-ai-skill/patterns/client/app-flow.md`（本任务的主范式，**照抄结构**）
- `clover-ai-skill/reference/architecture.md`（分层铁律）
- `clover-ai-skill/reference/engine-mental-model.md` §1/§2（模块谁挂、生命周期）
- `clover-ai-skill/patterns/client/config.md`、`ui.md`
